...
public final class RecipePaths {
    ...
    static {
        ...
        createPath(ItemID._1DOSE1AGILITY,
        ...
        createPath(ItemID.CADANTINE_BLOODVIAL,
        ...
        createPath(ItemID._1DOSE1ANTIDRAGON);
        ...
        createPath(ItemID._1DOSEPOTIONOFZAMORAK,
                ItemID._1DOSESURGE, ItemID._1DOSE2COMBAT);
        ...
        // JUDGEMENT: super and extended antifire are one choice; extending further is its own
        createPath(ItemID._1DOSE3ANTIDRAGON,
                ItemID._1DOSE2ANTIDRAGON);

        createPath(ItemID._1DOSE4ANTIDRAGON);

        createPath(ItemID._1DOSESTAMINA);

        createPath(ItemID._1DOSE2STAMINA);
